'use server'
import { space } from '@space/000.space.pvt';
import * as SHAPE from "@space/val/shape";
...
export const shapeHexmap = async (val) => {

  var dat = {frm:null, w:null, h:null }
  dat.frm = SHAPE.RECTANGLE;
  if (dat.w == null) dat.w = 10;
  if (dat.h == null) dat.h = 10;

  bit0 = await space(ActMap.SHAPE_HEXMAP, {dat})
  return bit0
}
...
export const writeFocus = async (dat) => {

  //var bit = await space(ActFoc.WRITE_FOCUS, dat)
  //dat = bit['focBit'].dat
